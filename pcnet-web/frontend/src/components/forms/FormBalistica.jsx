...
export default function FormBalistica({ form, onChange }) {
    ...
    const handleMunicaoChange = (index, field, value) => {
        const novasMunicoes = (form.municoes || []).map((municao, i) =>
            i === index ? { ...municao, [field]: value } : municao
        );
        ...
        <div className="bg-gray-50 p-6 rounded-xl border border-gray-200 space-y-6">
                        ...
                        >
                            ...
                            {!isMunicao ? (
                                <>
                                    ...
                                    {form.tipo_material === 'pistola' && <option value="nao_calcou">Não Calçou</option>}
                                    {form.tipo_material !== 'revolver' && <option value="rajada">Rajada</option>}
                                </>
                            ) : (
                                <>
            ...
            {!isMunicao && (
                <div>
                    ...
                    {form.tipo_material === 'fuzil' && (
                        <div className="mb-4 bg-emerald-50 p-4 border border-emerald-100 rounded-lg shadow-sm">
                            <h4 className="text-sm font-bold text-emerald-900 mb-3">Detalhes do Fuzil</h4>
                            <input
                                type="text"
                                name="detalhes_fuzil"
                                value={form.detalhes_fuzil || ''}
                                onChange={onChange}
                                placeholder="Ex: coronha rebatível e empunhadura em polímero"
                    ...
                    {(!isMunicao || form.destino !== 'consumida') && (
                        <div>
                            <label className="block text-xs font-semibold text-gray-600 mb-1">
                                Nº do Lacre <span className="font-normal text-gray-400">(opcional)</span>
                            </label>
                            <input 
                                type="text" 
                                name="n_lacre" 
                    ...
                    {form.resultado_exame === 'ineficiente' && (
                        <div>
                            ...
                            <input 
                                ...
                                onChange={onChange}
                                required
                                placeholder="Ex: mecanismo de disparo emperrado" 
