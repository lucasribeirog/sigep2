...
function processarDrogas(dadosForm, caminhoFoto = null, favDetectadaHeader = null) {
    // =========================================================================
    ...
    const corFinal = isMaconha ? '' : (dadosForm.cor_material || 'branca');
    const favHeaderFinal = dadosForm.numero_fav || dadosForm.fav || favDetectadaHeader || '';
